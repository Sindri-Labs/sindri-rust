...
**commitment_scheme** | Option<[**serde_json::Value**](.md)> | The commitment scheme used in the Jolt zkVM prover. | 
**std_enabled** | Option<[**serde_json::Value**](.md)> | Whether the Rust standard library is enabled for the guest code. | 
**jolt_version** | Option<[**serde_json::Value**](.md)> | The Jolt frontend version tag. | 
**package_name** | Option<[**serde_json::Value**](.md)> | The name of the circuit project specified in the included Cargo.toml file. | 
**guest_function** | Option<[**serde_json::Value**](.md)> | The name of the guest function in the user's uploaded guest code. | 
