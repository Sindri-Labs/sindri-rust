...
**num_constraints** | Option<[**serde_json::Value**](.md)> | The number of constraints in the Rank-1 Constraint System (R1CS) of the circuit. | 
**num_outputs** | Option<[**serde_json::Value**](.md)> | The number of public outputs from the circuit. | 
**num_private_inputs** | Option<[**serde_json::Value**](.md)> | The number of private inputs for the circuit. | 
**num_public_inputs** | Option<[**serde_json::Value**](.md)> | The number of public inputs for the circuit. | 
