...
**compute_time_sec** | Option<**f32**> | Total compute time in seconds. | 
...
**queue_time_sec** | Option<**f32**> | Queue time in seconds. | 
...
**num_constraints** | Option<**i32**> | The number of constraints in the Rank-1 Constraint System (R1CS) of the circuit. | 
**num_outputs** | Option<**i32**> | The number of public outputs from the circuit. | 
**num_private_inputs** | Option<**i32**> | The number of private inputs for the circuit. | 
**num_public_inputs** | Option<**i32**> | The number of public inputs for the circuit. | 
**class_name** | **String** | The path to the circuit struct definition. This is specified during creation in the included sindri.json file. | 
**degree** | **i32** | The log_2 of the number of rows in the circuit, expressed as a matrix. | 
**halo2_version** | **String** | The Halo2 frontend version tag. | 
**gnark_version** | **String** | The Gnark frontend version tag. | 
**commitment_scheme** | **String** | The commitment scheme used in the Jolt zkVM prover. | 
**std_enabled** | **bool** | Whether the Rust standard library is enabled for the guest code. | 
**jolt_version** | **String** | The Jolt frontend version tag. | 
**package_name** | **String** | The name of the circuit project specified in the included Cargo.toml file. | 
