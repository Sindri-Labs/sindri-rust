...
impl UserMeResponse {
    ...
    pub fn new(id: Option<serde_json::Value>, first_name: Option<serde_json::Value>, last_name: Option<serde_json::Value>, username: Option<serde_json::Value>, email: Option<serde_json::Value>, date_joined: Option<serde_json::Value>, teams: Option<serde_json::Value>) -> UserMeResponse {
        UserMeResponse {
            id,
            first_name,
            last_name,
