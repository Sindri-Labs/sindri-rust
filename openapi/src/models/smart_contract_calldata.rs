...
/// SmartContractCalldata : The proof and public formatted as calldata for the smart contract verifier.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SmartContractCalldata {}

impl SmartContractCalldata {
    /// The proof and public formatted as calldata for the smart contract verifier.
    pub fn new() -> SmartContractCalldata {
