...
pub struct TeamDetail {
    ...
    #[serde(rename = "is_personal", deserialize_with = "Option::deserialize")]
    pub is_personal: Option<serde_json::Value>,
    /// The name of the team.
    #[serde(rename = "name", deserialize_with = "Option::deserialize")]
    pub name: Option<serde_json::Value>,
    /// The number of projects owned by the team.
    #[serde(rename = "num_projects", deserialize_with = "Option::deserialize")]
    pub num_projects: Option<serde_json::Value>,
    ...
    #[serde(rename = "sindri_corporate", deserialize_with = "Option::deserialize")]
    pub sindri_corporate: Option<serde_json::Value>,
...
impl TeamDetail {
    ...
    pub fn new(avatar_url: Option<serde_json::Value>, date_created: Option<serde_json::Value>, description: Option<serde_json::Value>, id: Option<serde_json::Value>, is_personal: Option<serde_json::Value>, name: Option<serde_json::Value>, num_projects: Option<serde_json::Value>, num_proofs: Option<serde_json::Value>, sindri_corporate: Option<serde_json::Value>, slug: Option<serde_json::Value>, url: Option<serde_json::Value>) -> TeamDetail {
        TeamDetail {
            avatar_url,
            date_created,
            description,
