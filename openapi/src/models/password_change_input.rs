...
pub struct PasswordChangeInput {
    /// Old password.
    #[serde(rename = "old_password", deserialize_with = "Option::deserialize")]
    pub old_password: Option<serde_json::Value>,
    /// New password.
    #[serde(rename = "new_password", deserialize_with = "Option::deserialize")]
    pub new_password: Option<serde_json::Value>,
}

impl PasswordChangeInput {
    /// Client input to change their password.
    pub fn new(old_password: Option<serde_json::Value>, new_password: Option<serde_json::Value>) -> PasswordChangeInput {
        PasswordChangeInput {
            old_password,
            new_password,
        }
