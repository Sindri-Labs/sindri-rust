...
impl ProjectLatestCircuitResponse {
    ...
    pub fn new(circuit_id: Option<serde_json::Value>, circuit_type: crate::models::CircuitType, date_created: Option<serde_json::Value>, proving_scheme: Option<serde_json::Value>, status: crate::models::JobStatus) -> ProjectLatestCircuitResponse {
