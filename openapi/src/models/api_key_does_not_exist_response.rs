...
pub struct ApiKeyDoesNotExistResponse {
    ...
    pub apikey_id: Option<serde_json::Value>,
...
impl ApiKeyDoesNotExistResponse {
    ...
    pub fn new(apikey_id: Option<serde_json::Value>, error: Option<serde_json::Value>, message: Option<serde_json::Value>) -> ApiKeyDoesNotExistResponse {
