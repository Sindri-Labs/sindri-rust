...
pub struct JoltCircuitInfoResponse {
    ...
    #[serde(rename = "commitment_scheme", deserialize_with = "Option::deserialize")]
    pub commitment_scheme: Option<serde_json::Value>,
    /// Whether the Rust standard library is enabled for the guest code.
    #[serde(rename = "std_enabled", deserialize_with = "Option::deserialize")]
    pub std_enabled: Option<serde_json::Value>,
    /// The Jolt frontend version tag.
    #[serde(rename = "jolt_version", deserialize_with = "Option::deserialize")]
    pub jolt_version: Option<serde_json::Value>,
