...
impl ProjectInfoResponseLatestCircuit {
    ...
    pub fn new(circuit_id: Option<serde_json::Value>, circuit_type: models::CircuitType, date_created: Option<serde_json::Value>, proving_scheme: Option<serde_json::Value>, status: models::JobStatus) -> ProjectInfoResponseLatestCircuit {
