...
pub struct ProofListInput {
    ...
    pub date_created_after: Option<Option<serde_json::Value>>,
    ...
    pub date_created_before: Option<Option<serde_json::Value>>,
    ...
    pub project_name: Option<Option<serde_json::Value>>,
    #[serde(rename = "status", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub status: Option<Option<crate::models::JobStatus>>,
}
