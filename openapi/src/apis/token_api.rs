...
pub async fn jwt_token_generate(configuration: &configuration::Configuration, token_obtain_pair_input_schema: models::TokenObtainPairInputSchema) -> Result<models::TokenObtainPairOutputSchema, Error<JwtTokenGenerateError>> {
    ...
    let local_var_uri_str = format!("{}/api/token/pair", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&token_obtain_pair_input_schema);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<JwtTokenGenerateError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn jwt_token_refresh(configuration: &configuration::Configuration, token_refresh_input_schema: models::TokenRefreshInputSchema) -> Result<models::TokenRefreshOutputSchema, Error<JwtTokenRefreshError>> {
    ...
    let local_var_uri_str = format!("{}/api/token/refresh", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&token_refresh_input_schema);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<JwtTokenRefreshError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn jwt_token_verify(configuration: &configuration::Configuration, token_verify_input_schema: models::TokenVerifyInputSchema) -> Result<serde_json::Value, Error<JwtTokenVerifyError>> {
    ...
    let local_var_uri_str = format!("{}/api/token/verify", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&token_verify_input_schema);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<JwtTokenVerifyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
