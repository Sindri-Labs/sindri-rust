...
pub async fn proof_delete(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProofDeleteError> =
...
pub async fn proof_detail(
    ...
    if let Some(ref local_var_str) = include_proof {
        local_var_req_builder =
            local_var_req_builder.query(&[("include_proof", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = include_public {
        local_var_req_builder =
            local_var_req_builder.query(&[("include_public", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProofDetailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
